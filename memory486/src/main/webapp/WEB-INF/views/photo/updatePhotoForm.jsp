...
<div class="form-group">
	<form id="form1" runat="server" method="post" action="updatePhoto" enctype="multipart/form-data" onsubmit="return update()">
		<input type="hidden" value="${photo.p_no }" name="p_no">
		...
		<input type="file" onchange="readURL(this);" id="focusedInput" name="upfile" class="upload" required="required"><p>
		<img id="blah" width = "149px" height = "179px"	src="${path }/upload/${photo.p_file}" alt="이미지를 선택하세요." /><p>
